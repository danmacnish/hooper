...
var Carousel = {
  ...
  watch: {
    group: function group(val, oldVal) {
      ...
      EMITTER.$off('slide-group:'.concat(oldVal), this._groupSlideHandler);
  ...
  methods: {
    ...
    slideTo: function slideTo(slideIndex) {
      ...
      if (this.group && isSource) {
        EMITTER.$emit('slide-group:'.concat(this.group), slideIndex);
      }
    ...
    addGroupListeners: function addGroupListeners() {
      ...
      EMITTER.$on('slide-group:'.concat(this.group), this._groupSlideHandler);
    }
  },
  ...
  beforeDestroy: function beforeDestroy() {
    ...
    if (this.group) {
      EMITTER.$off('slide-group:'.concat(this.group), this._groupSlideHandler);
    }
