  ...
  (i = function(t, i) {
        ...
        for (var i = Object(t), e = 1; e < arguments.length; e++) {
          ...
          if (null != r) {
            ...
            for (var n = Object.keys(Object(r)), o = 0, s = n.length; o < s; o++) {
              var h = n[o],
                a = Object.getOwnPropertyDescriptor(r, h);
              void 0 !== a && a.enumerable && (i[h] = r[h]);
            }
          }
        }
        return i;
    ...
    var f = new i(),
      h = {
          ...
          trackTransform: function() {
            var t = this.config,
              ...
              a =
                ...
                o * ((n ? (h - s) / 2 : 0) - (i ? s * this.slidesCount : 0) - this.currentSlide * s);
        ...
        watch: {
          group: function(t, i) {
            t !== i && (f.$off('slide-group:'.concat(i), this._groupSlideHandler), this.addGroupListeners());
          }
        },
        methods: {
          slideTo: function(t, i) {
            ...
            if (!this.isSliding && t !== this.currentSlide) {
              this.$emit('before-slide', { currentSlide: this.currentSlide, slideTo: a });
              var n = this.config,
                o = n.infiniteScroll,
                s = n.transition,
                h = this.currentSlide,
              ...
              this.group && r && f.$emit('slide-group:'.concat(this.group), t),
                (this.currentSlide = a),
                (this.isSliding = !0),
          ...
          onTransitionend: function() {
            (this.isSliding = !1), this.$emit('after-slide', { currentSlide: this.currentSlide });
          },
          ...
          addGroupListeners: function() {
            ...
            this.group &&
              ...
              f.$on('slide-group:'.concat(this.group), this._groupSlideHandler));
          }
        },
        created: function() {
          this.initDefaults();
        ...
        beforeDestroy: function() {
          window.removeEventListener('resize', this.update),
            this.group && f.$off('slide-group:'.concat(this.group), this._groupSlideHandler),
              ...
              var i = function(t) {
                  for (var i = p(this), e = i.length, r = 0, n = [], o = 0; o < e; o++) {
                    ...
                    h &&
                      ...
                      (s.data.key = r),
                      (s.key = r),
                      (s.data.props = a({}, s.data.props || {}, { isClone: !1, index: r++ })),
                      n.push(s));
                  }
                    ...
                    this.config.infiniteScroll &&
                      (n = (function(t, i) {
                        for (var e = [], r = [], n = i.length, o = 0; o < n; o++) {
                          var s = i[o],
                            h = d(t, s);
                          (h.data.key = 'index-'.concat(o - n)),
                            (h.key = h.data.key),
                            (h.data.props = { index: o - n, isClone: !0 }),
                            e.push(h);
                          var a = d(t, s);
                          (a.data.key = 'index-'.concat(o + n)),
                            (a.key = a.data.key),
                            (a.data.props = { index: o + n, isClone: !0 }),
                            r.push(a);
                        }
        ...
        computed: {
          ...
          lower: function() {
            var t = this.$hooper || {},
              ...
              e = t.currentSlide,
              r = i.itemsToShow;
            return i.centerMode ? Math.ceil(e - r / 2) : e;
          },
          upper: function() {
            var t = this.$hooper || {},
              i = t.config,
              e = t.currentSlide,
              r = i.itemsToShow;
            return i.centerMode ? Math.floor(e + r / 2) : Math.floor(e + r - 1);
          },
          isActive: function() {
                    ...
                    var n = [],
                      o = function(t) {
                        n.push(
                          (function(t, i, e, r) {
                            return t('li', [
                              t('button', { class: { 'hooper-indicator': !0, 'is-active': e }, on: { click: r } }, [
